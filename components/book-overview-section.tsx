            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground italic">
                  A true story of hardship, cultural differences, and
                  resilience.
                </p>
              </div>
              ...
              <div className="space-y-6 text-lg leading-relaxed text-foreground/90">
                <p>
                  In this deeply personal memoir, Fatouma N Ali shares her
                  journey through life — a journey shaped by cultural barriers,
                  racism, injustice, and the strength required to survive them.
                </p>
                <p>
                ...
                <p className="font-medium text-foreground">
                  This book is a reflection on struggle, healing, and faith, and
