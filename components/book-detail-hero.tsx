        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-6">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-balance">The Reason Why</h1>
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                Born in Qatar to a Yemeni and Somali family, Fatouma grew up navigating complex family circumstances and
                social challenges across different countries. This book is a reflection on struggle, healing, and faith,
