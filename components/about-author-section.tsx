          ...
          <div className="grid gap-12 lg:grid-cols-[2fr_3fr] lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-foreground/90">
                <p>
                  Fatouma Nasser Ali is a business entrepreneur and a graduate
                  in Business Administration Management.
                </p>
                <p>
                  Her life story spans multiple countries and cultures. From her
                  early years in Qatar to her experiences navigating different
                  societies, Fatouma faced cultural, racial, and social barriers
                  that shaped her resilience and determination.
                </p>
                <p className="font-medium text-foreground">
                  With the support of meaningful mentors, family members, and
                  her faith, she transformed hardship into purpose.
                </p>
              </div>
            </div>
          </div>
